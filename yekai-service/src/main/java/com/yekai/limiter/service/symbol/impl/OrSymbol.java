 ...
 */
@Slf4j
@SymbolEnum(level = Level.L13, symbol = "||",name = "逻辑或")
public class OrSymbol extends Cell implements Symbol {

    public OrSymbol() {
        super(CellType.SYMBOL, OrSymbol.class.getAnnotation(SymbolEnum.class).symbol());
    }
